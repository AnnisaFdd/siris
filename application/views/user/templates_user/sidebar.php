<body id="page-top">
  ...
  <div id="wrapper" >
    ...
    <!-- Sidebar -->
    <ul class="navbar-nav sidebar sidebar-dark accordion bg-pink" id="accordionSidebar" style="overflow-x: hidden;position: fixed;z-index: 1;" \>
    ...
    <!-- Content Wrapper -->
    <div id="content-wrapper" class="d-flex flex-column" style="margin-left: 16.5%;">
