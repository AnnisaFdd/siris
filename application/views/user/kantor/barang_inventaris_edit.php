        ...
        <div class="row">
            ...
            <div class="col-md-6">
              <div class="card mb-4 py-3 border-left-danger">
                <div class="card-body">
                  ...
                  <b> <nav aria-label="breadcrumb">
                        <ol class="breadcrumb" style="background: #fce6e8;">
                          <li class="breadcrumb-item"><?php echo anchor('user/kantor/inventaris','<i class="far fa-edit"></i> Kelola Inventaris'); ?></li>
                ...
                <form method="post" action="<?php echo base_url('user/kantor/barang_inventaris_update') ?>">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      ...
                      <?php echo form_hidden('nama_ruang', $iv->nama_ruang); ?>
