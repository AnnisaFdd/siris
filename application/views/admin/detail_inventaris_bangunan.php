    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div class="container-fluid">
        <div class="alert bg-content" role="alert">
          <i class="fas fa-plus-square"></i> Detail Inventaris Bangunan
        </div>
              ...
              <div class="card mb-4 py-3 border-left-danger">
                <div class="card-body">
                  ...
                  <b> <nav aria-label="breadcrumb">
                        <ol class="breadcrumb" style="background: #fce6e8;">
                          <li class="breadcrumb-item"><?php echo anchor('admin/bangunan','<i class="fas fa-search"></i> Kelola Inventaris Bangunan'); ?></li>
                ...
                <form>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input required="required" type="text" name="bangunan" class="form-control" value="<?php echo  $bgn->nama_bangunan?>" readonly>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input required="required" type="number" name="luas_bangunan" class="form-control" value="<?php echo  $bgn->luas_bangunan?>" readonly>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input required="required" type="number" name="jumlah_lantai" class="form-control" value="<?php echo  $bgn->jumlah_lantai?>" readonly>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" name="njop" class="form-control" value="<?php echo $bgn->nama_bidang?>" readonly>
                    </div>
                  </div>
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" name="njop" class="form-control" value="<?php echo $bgn->nama_status?>" readonly>
                    </div>
                  </div>
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" name="njop" class="form-control" value="<?php echo $bgn->nama_sumber?>" readonly>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" name="njop" class="form-control" value="<?php echo $bgn->nama_aset?>" readonly>
                    </div>
                  </div>
